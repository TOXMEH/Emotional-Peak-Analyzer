...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(40, 210, 341, 51))
        ...
        self.spinBox.setGeometry(QtCore.QRect(30, 50, 51, 22))
        self.spinBox.setProperty("value", 5)
        self.spinBox.setObjectName("spinBox")
        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(40, 280, 341, 51))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Построить график эмоциональных импульсов"))
        ...
        self.pushButton_2.setText(_translate("Form", "Построить гистограмму распределения"))
